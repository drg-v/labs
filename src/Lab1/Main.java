...
class Example {
    ...
    public static void main(String[] args) {
        ...
        Chair obj1 = new Chair(40.0f, ChairLegs.THREE, 10.0f, 10.0f, 60.0f, 50.0f, "First", obj);
        Chair obj2 = new Chair(40.0f, ChairLegs.THREE, 10.0f, 10.0f, 60.0f, 50.0f, "First", obj);
